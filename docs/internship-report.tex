...
\end{figure}
In the case where we have 1 criterion the two value functions are identical $v^R = v^T$. Thus, we can see that the two list are identical.\\

\item The following graph represents the simulation results where we evaluated $10,000$ alternatives by taking $50$ alternatives as examples and by varying the number of criteria $[1, 2, 3, 4, 5]$ 
\begin{figure}[H]
\centering
